#include "kawai_airsim_controller/get_drone_image.h"
...
cv::Mat GetDroneImage::get_image(){
...
std::vector<cv::Mat> GetDroneImage::get_image_windows(cv::Mat original_mono_image){
    ...
    if(get_window_checker==true){
        ...
        windows.push_back(original_mono_image);
    }
...
float GetDroneImage::convert_angle(float rad){
...
*/
        ...
        cv::Mat original_mono_image = get_image();
